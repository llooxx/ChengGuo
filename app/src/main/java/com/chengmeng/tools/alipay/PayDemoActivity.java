...
public class PayDemoActivity extends FragmentActivity {
    ...
    // 商户PID
    public static final String PARTNER = "2088221600673106";
    // 商户收款账号
    public static final String SELLER = "jinanchengmeng@outlook.com";
    ...
    private String sign(String content) {
        return AlipaySignUtils.getAlipaySign(content);
    }
